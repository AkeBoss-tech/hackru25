#!/usr/bin/env python3
"""
Face Search Interface for Sex Offender Vector Database
Interactive interface for searching faces and managing the database
"""
...
class FaceSearchInterface:
    def __init__(self):
        self.db = FaceVectorDatabase()
        self.running = True
    
    def display_menu(self):
        """Display the main menu"""
        print("\n" + "="*60)
        print("🔍 FACE SEARCH INTERFACE - Sex Offender Database")
        print("="*60)
    ...
    def search_by_face(self):
        ...
        try:
            ...
            tolerance = float(input("Similarity tolerance 0.0-1.0 (default 0.6): ") or "0.6")
        except ValueError:
        ...
        # Perform search
        results = self.db.search_by_face(query_path, top_k=top_k, tolerance=tolerance)
    ...
    def export_database(self):
        ...
        export_path = input("Enter export file path (default: face_vector_export.json): ").strip()
        if not export_path:
            export_path = "face_vector_export.json"
    ...
    def run(self):
        ...
        print("🚀 Starting Face Search Interface...")
